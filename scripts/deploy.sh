...
create_conda_environments() {
    ...
    declare -A envs=(
        ["env-bot"]="python=3.11 python-telegram-bot fastapi uvicorn httpx psutil structlog python-dotenv"
        ["env-scheduler"]="python=3.11 apscheduler fastapi uvicorn httpx structlog python-dotenv"
        ["env-finance"]="python=3.11 fastapi uvicorn sqlalchemy pandas numpy structlog python-dotenv"
        ["env-market"]="python=3.11 fastapi uvicorn pandas numpy websockets httpx structlog python-dotenv"
        ["env-execution"]="python=3.11 fastapi uvicorn pandas numpy httpx structlog python-dotenv"
    )
