...
class Settings(BaseSettings):
    ...
    # MetaTrader Configuration (for direct connection, if not using BVM)
    ...
    bvm_mt5_enabled: bool = Field(False, env="BVM_MT5_ENABLED")
    bvm_vm_ip: str = Field("localhost", env="BVM_VM_IP")
    bvm_vm_port: int = Field(8080, env="BVM_VM_PORT")

    # Hybrid Mode Settings
    use_hybrid_analysis: bool = Field(True, env="USE_HYBRID_ANALYSIS")
    mt5_for_execution_only: bool = Field(True, env="MT5_FOR_EXECUTION_ONLY")
